...
char inf_captured_name[512];
int inf_captured_counter = 0;
...
static void vblank(GB_gameboy_t *gb)
{
    ...
    if( inf_captured_counter > 0 ) {
        show_osd_text( inf_captured_name );
    	inf_captured_counter--;
    }
...
int main(int argc, char **argv)
{
    ...
    window = SDL_CreateWindow("SameBoy custom by Hid v" GB_VERSION, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
